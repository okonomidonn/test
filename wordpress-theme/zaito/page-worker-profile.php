...
$education_options = array( '中学校卒業', '高等学校卒業', '専門学校卒業', '短期大学卒業', '大学卒業', '大学院卒業', 'その他' );
?>
      ...
      <div class="apply-card">
        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="apply-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="furigana" name="furigana" value="<?php echo esc_attr( $furigana ); ?>" placeholder="ヤマダ タロウ" />
          </div>

          <div class="job-info-grid" style="margin-bottom:20px;">
            <div class="form-group" style="margin-bottom:0;">
              <label for="birthdate">生年月日</label>
              <input type="date" id="birthdate" name="birthdate" value="<?php echo esc_attr( $birthdate ); ?>" />
            </div>
            <div class="form-group" style="margin-bottom:0;">
          ...
          <div class="form-group">
            ...
            <small>応募時に企業へ表示されます。空欄でも応募は可能です。</small>
          </div>
